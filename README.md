...
```
  > git clone git@github.com:chardy/sweeui.git
  > cd sweeui
  > yarn install
```
...
Click [here](https://github.com/chardy/sweeui/archive/master.zip) to download the .zip file. Extract the contents of the zip file, then open your terminal, change to the project directory, and:
...
Always provide an `YourComponent.md` file, so your component will show up in the Styleguide.
